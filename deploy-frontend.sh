...
[ -f "packages/ai-agents/ui_generation_agent_url.txt" ] && UI_GENERATION_URL=$(cat packages/ai-agents/ui_generation_agent_url.txt)
...
[ -n "$UI_GENERATION_URL" ] && ENV_VARS="$ENV_VARS,UI_GENERATION_AGENT_URL=$UI_GENERATION_URL"
