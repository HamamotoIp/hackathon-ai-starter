...
AI Chat Starter Kitは、機能ベースでAIを使い分けるハッカソン特化のチャットシステムです。Vertex AI Direct（高速）とADK Agent Engine（高品質）を適切に使い分け、高速セットアップから本格運用まで対応します。
...
この設計により、高速セットアップから本格的なプロダクション運用まで、シームレスに拡張可能な柔軟性を実現しています。